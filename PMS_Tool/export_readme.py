...
FEATURES = [
    ...
    "治具管理 (已完成_建立治具、刪除治具、修改資料、入庫、執行調撥、生成儲位、匯出Excel(本幣單價、外幣單價、料件總價、倉別總價、預估料件請購金額、預估請購總金額);未完成_安庫告警)",
    "治具紀錄 (已完成_出入庫紀錄_治具料號、治具品名、治具規格、動作、異動數量、來源倉、目的倉、治具操作人、時間)",
    "治具BOM (設計中_父子料號替代關聯_右鍵選單新增父子料號關聯)",
    "治具申請 (待規劃_申請單、審核)",
    "治具損耗 (待規劃_POWERBI_報表)",
    "異常平台 (待規劃_Trobleshoot Platform)",
    "帳號管理 (已完成_帳號、角色、專長、新增、刪除、啟用、上傳SOP、可見記錄、刪除記錄、可見SOP、帳號管理;治具管理模組化)",
